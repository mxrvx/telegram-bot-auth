...
if (!\class_exists('\\modUserProfile') && \class_exists('\\MODX\\Revolution\\modUserProfile')) {
    \class_alias('\\MODX\\Revolution\\modUserProfile', '\\modUserProfile');
}
...
if (!\class_exists('\\modCategory') && \class_exists('\\MODX\\Revolution\\modCategory')) {
    \class_alias('\\MODX\\Revolution\\modCategory', '\\modCategory');
}
if (!\class_exists('\\modSnippet') && \class_exists('\\MODX\\Revolution\\modSnippet')) {
    \class_alias('\\MODX\\Revolution\\modSnippet', '\\modSnippet');
}
if (!\class_exists('\\modSession') && \class_exists('\\MODX\\Revolution\\modSession')) {
    \class_alias('\\MODX\\Revolution\\modSession', '\\modSession');
}
...
if (!\class_exists('\\modMail') && \class_exists('\\MODX\\Revolution\\Mail\\modMail')) {
    \class_alias('\\MODX\\Revolution\\Mail\\modMail', '\\modMail');
}
if (!\class_exists('\\modPHPMailer') && \class_exists('\\MODX\\Revolution\\Mail\\modPHPMailer')) {
    \class_alias('\\MODX\\Revolution\\Mail\\modPHPMailer', '\\modPHPMailer');
}
